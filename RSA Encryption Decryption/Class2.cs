...
namespace CommonUtils
{
...

    {
        ...
        #region  Load private key 

        /// <summary>
        ///  Convert the private key string to RSACryptoServiceProvider
        /// </summary>

        /// <param name="privateKeyStr"> Private key string </param>
        /// <param name="keyFormat">PKCS8,PKCS1</param>

        /// <param name="signType">RSA  The length of the private key 1024 ,RSA2  The length of the private key 2048</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// PKCS1  Format private key to  RSACryptoServiceProvider  object 
        /// </summary>

        /// <param name="strKey">pcsk1  The text content of the private key </param>
        /// <param name="signType">RSA  The length of the private key 1024 ,RSA2  The length of the private key 2048 </param>
        /// <returns></returns>
        ...
        /// <summary>
        /// PKCS8  Text to RSACryptoServiceProvider  object 
        /// </summary>
        ...
        public static RSACryptoServiceProvider LoadPrivateKeyPKCS8(string privateKeyPemPkcs8)
        {
            try
            {
                ...
                //pkcs8  The text first turns to  .NET XML  Private key string 
        ...
        /// <summary>
        /// PKCS8  Private key text   turn  .NET XML  Private key text 
        /// </summary>
        /// <param name="privateKeyPemPkcs8"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="publicKeyCert"> Text content of public key certificate </param>
        /// <returns></returns>
        ...
        /// <summary>
        /// pem  Public key text   turn   .NET RSACryptoServiceProvider.
        /// </summary>
        ...
        public static RSACryptoServiceProvider LoadPublicKey(string publicKeyPem)
        {
            ...
            //pem  Public key text   turn   .NET XML  Public key text .
